...
// Middleware
app.use(helmet({
    // Allow use in iframes for demo purposes
...
// Serve static files from the client-demo directory
...
const startServer = async () => {
    try {
        ...
        // This will make the first detection faster for users
        ...
        app.listen(PORT, () => {
            ...
            console.log(`Demo application available at http://localhost:${PORT}/demo`);
        });
    } catch (error) {
